...
export default function Philosophy() {
  ...
  return (
    <section className="py-16 md:py-24 lg:py-32 px-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-0 w-96 h-96 bg-gradient-to-r from-blue-500/10 to-transparent rounded-full blur-3xl" />
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {values.map((value, index) => (
            <div key={index} className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl blur-xl group-hover:blur-2xl transition-all opacity-0 group-hover:opacity-100" />
              <div className="relative bg-card/80 backdrop-blur-sm border border-border/50 rounded-3xl p-6 md:p-8 hover:border-primary/30 transition-all h-full">
        ...
        <div className="mt-12 md:mt-16 text-center">
          <div className="inline-block bg-gradient-to-r from-purple-500/10 via-blue-500/10 to-pink-500/10 border border-primary/20 rounded-2xl p-6 md:p-8 max-w-4xl">
